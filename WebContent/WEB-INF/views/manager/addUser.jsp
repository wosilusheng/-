...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
    	function check(){
    		...
    		if(pwd.length<6){
    			$("#error").text("密码长度不能低于6位");
    			return false;
    		}
    		var rePwd=$.trim($("#rePwdId").val());
    		if(pwd!=rePwd){
    			$("#error").text("两次输入的密码不同");
    			return false;
    		}
    		return true;
    	}
  ...
  <body role="document">
          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu ">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/manager/addUser">添加用户</a></li>
              </ul>
            </li>
    ...
    <div class="container theme-showcase" role="main">
		<form  action="${pageContext.request.contextPath}/manager/addUser" method="post" onsubmit="return check();">
			  ...
			  <div class="form-group">
			    <label for="pwdId">请输入密码</label>
			    <input type="password" class="form-control" id="pwdId" name="password" placeholder="密码">
			  </div>
			  <div class="form-group">
			    <label for="rePwdId">请再次输入新密码</label>
			    <input type="password" class="form-control" id="rePwdId" placeholder="确认密码">
			  </div>
